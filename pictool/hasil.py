...
def compare(image1,image2):
	...
	r = post('https://www.imgonline.com.ua/eng/similarity-percent-result.php',files=data)
...
def ocr(image):
	...
	r = post('https://www.imgonline.com.ua/eng/ocr-result.php',data=data,files=file)
...
def qrscan(image):
	...
	info = b.find('div',attrs={'style':'background-color:#CCFFCC;padding:5px;'}).text.replace('\n','')
...
def main():
	...
	arg.add_argument('-c',help='comparing two image',nargs=2,metavar=('image1','image2'))
	arg.add_argument('-a',help='print tool informations',nargs='?',const='about',metavar='about')
	arg.add_argument('-help',help='print help',nargs='?',const='p',type=str)
	...
	arg.add_argument('-C',help='Convert all image format to JPEG format',nargs=2,metavar=('image','output'))
	ar = arg.parse_args()
